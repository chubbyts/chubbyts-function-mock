...
[![CI](https://github.com/chubbyts/chubbyts-function-mock/actions/workflows/ci.yml/badge.svg?branch=master)](https://github.com/chubbyts/chubbyts-function-mock/actions/workflows/ci.yml)
...
```sh
npm i @chubbyts/chubbyts-function-mock@2.3.0
```
